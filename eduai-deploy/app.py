...
try:
    from eduai.app.routes.flutterwave_billing_routes import register_flutterwave_billing_routes
    register_flutterwave_billing_routes(app)
    print("[EDUAI] ✅ Flutterwave billing routes registered")
except Exception as e:
    print(f"[EDUAI] ⚠️  Flutterwave billing routes: {e}")
